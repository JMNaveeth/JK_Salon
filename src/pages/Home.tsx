...
// ── Owner photo – swap src to your actual import or public path ──────────────
// import ownerImg from '../assets/owner.jpg';
const ownerImg = '/owner.jpg'; // place the WhatsApp image in /public as owner.jpg
  ...
  return (
    <div className="bg-black text-white overflow-x-hidden">
      ...
      <section ref={heroRef} className="relative min-h-screen flex items-center overflow-hidden">
        ...
        {/* Floating particles */}
        {[...Array(12)].map((_, i) => (
          <Particle key={i} delay={i * 0.5} x={Math.random() * 100} size={3 + Math.random() * 5} />
        ))}
        ...
        >
          <div className="w-[820px] h-[820px] rounded-full border border-[#C5A059]" />
        </motion.div>
        ...
        <div className="absolute right-0 bottom-0 z-10 hidden lg:flex items-end justify-end w-[45%] h-full pointer-events-none">
          {/* Glow blob */}
          <motion.div
            className="absolute bottom-0 right-0 w-[480px] h-[580px] rounded-full"
            style={{ background: 'radial-gradient(ellipse at center, rgba(197,160,89,0.18) 0%, transparent 70%)', filter: 'blur(40px)' }}
            animate={{ scale: [1, 1.06, 1], opacity: [0.7, 1, 0.7] }}
            transition={{ duration: 4, repeat: Infinity, ease: 'easeInOut' }}
          />

          {/* Gold shimmer ring around image */}
          <motion.div
            className="absolute bottom-0 right-16 w-[400px] h-[500px]"
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
            transition={{ delay: 1 }}
          >
            ...
            {services.map((service, idx) => {
              ...
              return (
                <motion.div
                  ...
                  className="group bg-white border border-[#E5E5E5] rounded-2xl p-10 flex flex-col items-center text-center transition-shadow cursor-default"
                >
                  <motion.div
