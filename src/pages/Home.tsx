...
const SectionHeading = ({
  ...
  return (
    ...
    >
      <span className="text-[#C5A059] text-xs font-bold uppercase tracking-[0.4em] mb-4 block">
        {eyebrow}
      </span>
      <h2
        className={`text-5xl md:text-6xl font-serif tracking-tight mb-5 ${light ? "text-white" : "text-[#1A1A1A]"}`}
      >
        {title}
      </h2>
...
const ServiceCard = ({ service, idx }: { service: any; idx: number }) => {
  ...
  return (
    ...
    >
      ...
      <p className="text-[#C5A059] font-bold text-base mb-8 uppercase tracking-wider">
        LKR {service.price.toLocaleString()}
      </p>
      <Link
        to="/booking"
        className="group/btn px-8 py-2.5 border border-[#1A1A1A] rounded-full text-xs font-bold text-[#1A1A1A] hover:bg-[#1A1A1A] hover:text-white transition-all flex items-center gap-2"
      >
        Book Now{" "}
...
const WhyCard = ({
  ...
  return (
    ...
    >
      <div className="w-12 h-12 rounded-xl bg-[#C5A059]/10 flex items-center justify-center text-[#C5A059] mb-6">
        {icon}
      </div>
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        setReviews(
          reviewsData.filter((r: any) => r.status === "approved").slice(0, 3),
        );
      } catch (error) {
  ...
  const whyItems = [
    {
      ...
      desc: "Only the finest products and techniques for your grooming experience.",
    },
    {
      icon: <Clock className="h-6 w-6" />,
      title: "On Time Always",
      desc: "Punctual service that respects your busy schedule.",
    },
    {
      icon: <ShieldCheck className="h-6 w-6" />,
      title: "Certified Experts",
      desc: "Our barbers hold international certifications.",
    },
    {
      icon: <Sparkles className="h-6 w-6" />,
      title: "Luxury Ambience",
      desc: "Unwind in a space designed to feel like a retreat.",
    },
  ];

  const particles = [
    { delay: 0, x: 10, size: 4 },
    { delay: 0.5, x: 20, size: 3 },
    { delay: 1, x: 33, size: 5 },
    { delay: 1.5, x: 45, size: 3 },
    { delay: 2, x: 55, size: 4 },
    { delay: 2.5, x: 65, size: 3 },
    { delay: 3, x: 72, size: 5 },
    { delay: 3.5, x: 80, size: 4 },
    { delay: 0.8, x: 88, size: 3 },
    { delay: 1.2, x: 94, size: 4 },
    { delay: 2.2, x: 15, size: 3 },
    { delay: 3.2, x: 40, size: 5 },
  ];
  ...
  return (
    <div className="bg-black text-white overflow-x-hidden">
      ...
      >
        ...
        {particles.map((p, i) => (
          <Particle key={i} delay={p.delay} x={p.x} size={p.size} />
        ))}
        ...
        <div className="absolute right-0 bottom-0 z-10 hidden lg:flex items-end justify-end w-[45%] h-full pointer-events-none">
          <motion.div
            className="absolute bottom-0 right-0 w-[500px] h-[600px] rounded-full"
            style={{
              background:
                "radial-gradient(ellipse at center, rgba(197,160,89,0.18) 0%, transparent 70%)",
              filter: "blur(40px)",
            }}
          ...
          />
          <motion.div
            className="absolute bottom-0 right-16 w-[400px] h-[500px] pointer-events-none"
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
            transition={{ delay: 1 }}
          >
            <motion.div
              ...
              style={{
                background: `conic-gradient(from 0deg, transparent 70%, ${GOLD} 85%, transparent 100%)`,
          ...
          >
            <motion.div
              className="absolute -left-12 top-24 z-20 bg-black/80 backdrop-blur-sm border border-[#C5A059]/40 rounded-2xl px-4 py-3 flex items-center gap-3"
            ...
            <motion.div
              className="absolute -right-8 top-1/3 z-20 bg-[#C5A059] rounded-2xl px-4 py-3 text-center shadow-2xl shadow-[#C5A059]/40"
              initial={{ opacity: 0, x: 30 }}
              animate={{ opacity: 1, x: 0 }}
            ...
            <motion.div
              ...
              style={{
                boxShadow: `0 0 0 1px rgba(197,160,89,0.3), 0 40px 80px rgba(0,0,0,0.6), 0 0 60px rgba(197,160,89,0.1)`,
              }}
              whileHover={{
                scale: 1.02,
                boxShadow: `0 0 0 2px rgba(197,160,89,0.6), 0 40px 80px rgba(0,0,0,0.6), 0 0 80px rgba(197,160,89,0.2)`,
              }}
            ...
            >
              ...
              <div className="absolute bottom-6 left-0 right-0 text-center">
                ...
                <p className="text-[#C5A059] text-xs tracking-widest">
                  Colombo, Sri Lanka
                </p>
              </div>
            </motion.div>
        ...
        {/* Hero text */}
        <motion.div
          className="relative z-10 max-w-7xl mx-auto px-6 sm:px-8 lg:px-12 pt-24 w-full"
          style={{ y: textY }}
        >
          <motion.div
            initial={{ opacity: 0, y: 40 }}
          ...
          >
            <motion.span
              className="inline-flex items-center gap-2 text-[#C5A059] text-xs font-bold uppercase tracking-[0.45em] mb-8"
            ...
            <div className="overflow-hidden mb-3">
              <motion.h1
                className="text-[5.5rem] md:text-[7rem] font-serif tracking-[-0.04em] leading-none text-white"
                initial={{ y: 120 }}
                animate={{ y: 0 }}
                transition={{
                  duration: 0.9,
            ...
            <div className="overflow-hidden mb-8">
              <motion.h1
                className="text-[5.5rem] md:text-[7rem] font-serif tracking-[-0.04em] leading-none"
                initial={{ y: 120 }}
                animate={{ y: 0 }}
                transition={{
                  duration: 0.9,
            ...
            <motion.p
              className="text-base md:text-lg text-zinc-400 mb-10 max-w-md leading-relaxed"
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
              transition={{ delay: 0.7, duration: 0.7 }}
            >
              Experience the pinnacle of luxury grooming. Our expert stylists
              combine traditional techniques with modern trends to craft your
              perfect look.
            </motion.p>
            <motion.div
            ...
            >
              <Link
                to="/booking"
                className="group relative overflow-hidden bg-[#C5A059] text-white px-8 py-4 rounded-full text-sm font-bold transition-all flex items-center justify-center gap-2 hover:shadow-2xl hover:shadow-[#C5A059]/40"
              >
              ...
              <Link
                to="/services"
                className="group bg-white/5 hover:bg-white/10 border border-white/10 hover:border-[#C5A059]/40 text-white px-8 py-4 rounded-full text-sm font-bold transition-all text-center flex items-center justify-center gap-2"
              >
                Explore Services
          ...
          <motion.div
            className="absolute bottom-12 left-6 sm:left-8 lg:left-12 flex gap-10 md:gap-16"
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
      ...
      <div className="py-5 bg-[#C5A059] overflow-hidden">
        ...
        >
          {[...Array(8)].map((_, i) => (
            <span
              key={i}
              className="text-black text-xs font-bold uppercase tracking-[0.3em] flex items-center gap-4"
            >
      ...
      <section className="py-28 bg-[#FDFBF7]">
        <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12">
          ...
          >
            <Link
              to="/services"
              className="text-[#C5A059] font-bold text-sm hover:underline flex items-center justify-center gap-2"
            >
      ...
      <section className="py-28 bg-zinc-950 relative">
        <div
          ...
          style={{
            backgroundImage:
              "radial-gradient(circle at 20% 50%, #C5A059 0%, transparent 50%), radial-gradient(circle at 80% 50%, #C5A059 0%, transparent 50%)",
          }}
        />
        <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            {reviews.length === 0 && (
              <div className="col-span-full text-center text-zinc-600 py-16">
      ...
      <section className="py-32 relative overflow-hidden">
        ...
        {[200, 350, 500].map((size, i) => (
          <motion.div
            key={i}
            className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 rounded-full border border-[#C5A059]/10 pointer-events-none"
        ...
        <div className="relative z-10 max-w-3xl mx-auto px-6 text-center">
          ...
          >
            <span className="text-[#C5A059] text-xs font-bold uppercase tracking-[0.4em] mb-6 block">
              Get Started Today
            </span>
            ...
            <p className="text-zinc-400 text-base mb-10 leading-relaxed">
              Book your appointment now and experience the finest grooming
              service in Colombo.
            </p>
            <motion.div whileHover={{ scale: 1.04 }} whileTap={{ scale: 0.97 }}>
              <Link
                to="/booking"
                className="inline-flex items-center gap-3 bg-[#C5A059] hover:bg-[#B48F48] text-white px-14 py-5 rounded-full text-base font-bold transition-all shadow-2xl shadow-[#C5A059]/30"
              >
