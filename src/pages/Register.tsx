...
import { Scissors, Mail, Lock, Eye, EyeOff, ArrowRight, Loader2, User, Sparkles, CheckCircle } from 'lucide-react';
...
const Register = () => {
    ...
    return (
        <div className="min-h-screen flex" style={{ background: CREAM }}>
            {/* Left Side — Form */}
            <div className="flex-1 flex items-center justify-center px-6 py-16 lg:px-16 order-2 lg:order-1">
                <motion.div
            ...
            <div className="hidden lg:flex lg:w-[48%] relative overflow-hidden items-center justify-center order-1 lg:order-2" style={{ background: '#0F0F0F' }}>
